...
{
    /// <summary>
    /// Вершина для создания плана здания
    /// </summary>
    public class VertexWall : IVertex
    {
        /// <summary>
        /// Название вершины
        /// </summary>
        ...
        public VertexWall(string vertexName)
        {
            Name = vertexName;
            Edges = new List<GraphEdge>();
        }
        ...
        public VertexWall(string vertexName, int X, int Y, int Z)
        {
            Name = vertexName;
        ...
        public override string ToString() => Name + " " + Point.ToString();
    }
}
